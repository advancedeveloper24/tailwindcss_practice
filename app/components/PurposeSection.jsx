import { features } from "@/public/assets/data";
...
const PurposeSection = () => {
  ...
  return (
    <section className="w-full bg-gray-100 py-16 px-4 sm:px6 md:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 grid-cols-1 gap-8">
          {/* Heading Text */}
          <div className="">
            <p className="text-sm text-purple-600 mb-2 font-bold">
              ACHIEVE MORE
            </p>
